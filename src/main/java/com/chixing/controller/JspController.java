...
public class JspController {
    ...
    public ModelAndView detailStory(Integer happId, HttpSession session,String happImage){
        ModelAndView modelAndView=new ModelAndView();
        Integer custId=(Integer)session.getAttribute("custId");
        Happiness happiness=happinessService.getHappinessByHappId(happId,custId);
