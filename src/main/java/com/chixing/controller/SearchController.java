...
public class SearchController {
    ...
    public void accurate(String nickname, HttpServletResponse response) throws IOException {
        Customer customer=customerService.getCustomerByNickname(nickname);
        response.sendRedirect("/customer/message?id="+customer.getCustId());
    }

    @RequestMapping(value="/hasNickname", method = RequestMethod.GET)
    public String  hasNickname(HttpServletRequest request){
