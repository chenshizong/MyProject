...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function mainResult(){
            var nickname=document.getElementsByClassName("keyword").item(0).value;
            if(checkNickname()==="yes")
                window.open("${pageContext.request.contextPath}/search/accurate?nickname="+nickname);
            else
                alert("该用户昵称不存在");
        }
        ...
        function checkNickname() {
            ...
            var result = "";
            $.ajax({
                url:'/search/hasNickname',
                type:"GET",
                data:{nickname:nickname}, // 发送数据
                dataType:"text",
