            ...
            <div id="main-left-top">
                <div id="top-part1">
                   <c:choose>
                       ...
                       <c:otherwise>
                           <a href="javascript:void(0)"><img src="/Path/${Photo}"></a>
                       </c:otherwise>
                   </c:choose>
                ...
                <div id="top-part2">
                    <a class="xx"  href="${pageContext.request.contextPath}/customer/getMyInfo"><p>${Nickname}</p></a>
                    <div class="p2">
